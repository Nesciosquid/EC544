    ...
    void setup() {
        ...
        timeScrubber = new Scrubber(timeScrubberInset, timeScrubberY, timeScrubberWidth, 15 * conversionFactor, true);
        turnScrubber = new Scrubber(width / 2 - timeScrubberInset, timeScrubberInset, width / 2 - timeScrubberInset, 15 * conversionFactor, true);
        //speedScrubber = new Scrubber();
        f = createFont("Arial", fontSize, true);
        fast = new Button(timeScrubberInset + 40 * conversionFactor, height - timeScrubberInset * 4, "fast");
        med = new Button(timeScrubberInset + 25 * conversionFactor, height - timeScrubberInset * 4, "med");
        slow = new Button(timeScrubberInset + 10 * conversionFactor, height - timeScrubberInset * 4, "slow");
