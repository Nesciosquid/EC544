...
//public float calcH(Beacon A, Beacon B, float
    ...
    public static void main(String args[]) {
        PApplet.main(new String[]{"localizationviz.LocalizationViz"});
        //LocalizationViz.isSimulating = true;
        float[] newReads = {230.0f, 230.0f, 230.0f, 230.0f};
        LocalizationViz.setReads(newReads);
        LocalizationViz.forceGuess();
    }
