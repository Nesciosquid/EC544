...
public class DataDaemon {
    ...
    public DataDaemon() { // for calculations only
        initRecents();
    }

    public DataDaemon(double distance, double conf) {
        sensorDistance = distance;
        confidenceDistance = conf;
        initRecents();
    }

    public void update(double LF, double RF, double LR, double RR) {
        setReadings(LF, RF, LR, RR);
        updateAngles();
        updateDistance();
        updateConfidence();
    }
    ...
    private void setReadings(double LF, double RF, double LR, double RR) {
        readingLF = LF;
        readingRF = RF;
        readingLR = LR;
        readingRR = RR;
